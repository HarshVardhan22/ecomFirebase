...
const SignUp = () => {
    ...
    return (
        <React.Fragment>
            ...
            <div className="row">
                <div className="col-8 offset-2 col-md-4 offset-md-4 text-center" ><h2>Sign Up</h2></div>
            </div>
                ...
                <div className="row ">
                    <div className="col-8 offset-2 col-md-4 offset-md-4">
                        <form>
                            ...
                            <button className="signUp__registerButton mt-2  mb-2" onClick={register}>Create Account</button>
                        </form>
